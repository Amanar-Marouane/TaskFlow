        ...
        <div class='flex flex-wrap items-center justify-between gap-4 w-full'>
            <a href="javascript:void(0)"
                class="lg:absolute max-lg:left-10 lg:top-2/4 lg:left-2/4 lg:-translate-x-1/2 lg:-translate-y-1/2 max-sm:hidden"><img
                    src="./../Media/logo.svg" alt="logo" class='w-20 h-fit' />
            </a>
            <a href="javascript:void(0)"
                class="hidden max-sm:block"><img
                    src="./../Media/logo-min.svg" alt="logo" class='w-10 h-fit' />
            </a>
            ...
            <div id="collapseMenu"
                ...
                <ul
                    ...
                    <li class='mb-6 hidden max-lg:block'>
                        <a href="javascript:void(0)"><img src="./../Media/logo.svg" alt="logo" class='w-20 h-fit' />
                        </a>
                    </li>
